        ...
        <div className="max-w-md mx-auto px-8">
          <div className="text-center mb-12">
            <div className="mb-8 flex flex-col items-center">
              <div className="w-28 h-28 mb-6 relative drop-shadow-xl">
              ...
              <div className="flex items-center justify-center space-x-3 mb-4">
                <span className="text-4xl font-extrabold text-gray-900 tracking-tight drop-shadow">Alumnote</span>
              </div>
              <h1 className="text-5xl font-extrabold text-gray-900 mb-2 tracking-tight drop-shadow-lg">
                Idea Campus
              </h1>
              <p className="text-lg text-gray-600 font-normal">革新的なアイデアを生み出そう</p>
            </div>
          </div>
          <div className="space-y-6">
            <button
              onClick={() => setCurrentView('adminAuth')}
              className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white py-6 px-8 rounded-3xl shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-between mb-2"
            >
              <span className="flex items-center space-x-4">
                <span className="w-12 h-12 bg-white/30 rounded-xl flex items-center justify-center">
                  <Settings className="w-6 h-6 text-white" />
                </span>
                <span className="text-xl font-semibold">管理者</span>
              </span>
              <ArrowLeft className="w-5 h-5 transform rotate-180" />
            </button>
            <button
              onClick={() => setCurrentView('student')}
              className="w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:to-pink-600 text-white py-6 px-8 rounded-3xl shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-between mb-2"
            >
              <span className="flex items-center space-x-4">
                <span className="w-12 h-12 bg-white/30 rounded-xl flex items-center justify-center">
                  <PenTool className="w-6 h-6 text-white" />
                </span>
                <span className="text-xl font-semibold">学生</span>
              </span>
              <ArrowLeft className="w-5 h-5 transform rotate-180" />
            </button>
            <button
              onClick={() => setCurrentView('presenter')}
              className="w-full bg-gradient-to-r from-blue-500 to-green-400 hover:from-blue-600 hover:to-green-500 text-white py-6 px-8 rounded-3xl shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-between"
            >
              <span className="flex items-center space-x-4">
                <span className="w-12 h-12 bg-white/30 rounded-xl flex items-center justify-center">
                  <Monitor className="w-6 h-6 text-white" />
                </span>
                <span className="text-xl font-semibold">ダッシュボード</span>
              </span>
              <ArrowLeft className="w-5 h-5 transform rotate-180" />
            </button>
          </div>
  ...
  if (currentView === 'student') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div className="bg-white/80 border-b border-gray-100 shadow-md">
        ...
        <div className="max-w-2xl mx-auto px-8 py-12">
          <div className="bg-white/90 rounded-3xl p-10 mb-8 shadow-2xl border border-blue-100">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-blue-500 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-lg">
                <Zap className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-4xl font-bold text-blue-700 mb-2 drop-shadow">{solutions.length}</h3>
              <p className="text-gray-500 font-light">投稿されたアイデア</p>
            </div>
          </div>
          <div className="bg-white/95 rounded-3xl p-10 shadow-2xl border border-blue-100">
            <StudentForm />
          </div>
        </div>
      </div>
  ...
  if (currentView === 'presenter') {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white">
        <div className="border-b border-gray-800 bg-gradient-to-r from-gray-900 to-blue-900">
        ...
        <div className="max-w-7xl mx-auto px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-8 text-center shadow-xl border border-blue-200">
              <div className="w-16 h-16 bg-white/20 rounded-2xl mx-auto mb-6 flex items-center justify-center">
                <Lightbulb className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-5xl font-extrabold mb-3 text-white drop-shadow">{solutions.length}</h3>
              <p className="text-white font-light text-lg">総アイデア数</p>
            </div>
            <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-3xl p-8 text-center shadow-xl border border-purple-200">
              <div className="w-16 h-16 bg-white/20 rounded-2xl mx-auto mb-6 flex items-center justify-center">
                <Trophy className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-5xl font-extrabold mb-3 text-white drop-shadow">{challengeStats.length}</h3>
              <p className="text-white font-light text-lg">活発な課題</p>
            </div>
            <div className="bg-gradient-to-br from-green-400 to-blue-500 rounded-3xl p-8 text-center shadow-xl border border-green-200">
              <div className="w-16 h-16 bg-white/20 rounded-2xl mx-auto mb-6 flex items-center justify-center">
                <Users className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-5xl font-extrabold mb-3 text-white drop-shadow">{groupStats.length}</h3>
              <p className="text-white font-light text-lg">参加チーム</p>
            </div>
          </div>
